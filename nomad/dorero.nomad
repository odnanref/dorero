...
"traefik.enable=true",
                ...
                "traefik.http.routers.dorero.rule=Host(`dorero.tellesribeiro.net`)",
                "traefik.http.routers.doreroweb.rule=Host(`dorero.tellesribeiro.net`)",
                "traefik.http.routers.dorero.entrypoints=websecure",
                "traefik.http.routers.doreroweb.entrypoints=web",
                "traefik.http.routers.dorero.tls=true",
                "traefik.http.routers.dorero.tls.certresolver=dorero",
                "traefik.http.services.dorero.loadbalancer.server.scheme=http",
                "traefik.http.services.dorero.loadbalancer.passhostheader=true",
                "traefik.http.services.dorero.loadbalancer.healthcheck.hostname=dorero.tellesribeiro.net",
                "traefik.http.services.dorero.loadbalancer.responseforwarding.flushinterval=10",
                "traefik.http.middlewares.dorero.redirectscheme.scheme=https",
                "traefik.http.middlewares.dorero.redirectscheme.permanent=true"
    ...
    task "dorero" {
      ...
      config {
        image = "registry.service.consul:5000/dorero:latest"
